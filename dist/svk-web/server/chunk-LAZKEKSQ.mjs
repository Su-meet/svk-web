...
import{B as $,Ua as l,f as v,j as d,lb as h}from"./chunk-MRPXWCBD.mjs";var f=class m{platformId=d($);storageService=d(h);businessNumber="918920803434";businessName="SVK Experts";generateBookingMessage(e,t,s,a,c,o){let i=e.discountedPrice??e.price,n=`\u{1F3E0} *New Booking Request - ${this.businessName}*
